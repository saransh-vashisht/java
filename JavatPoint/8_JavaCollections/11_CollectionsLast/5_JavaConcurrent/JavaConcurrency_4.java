...
// Java Linked Queue Example 2

import java.util.ArrayList;
import java.util.List;
import java.util.concurrent.ConcurrentLinkedQueue;

public class JavaConcurrency_4 {
    public static void main(String[] args) {
        ...
        System.out.println("Elements of the queue will get removed : "+ queue);

        // Retains only those elements in this queue that are present in the list 
